...
a persistence unit "service-pretPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "service-pret/pom.xml":
...
artifacts ("service-pret-ejb.jar" and "service-pret-web.war") are already built. You can build
