...
a persistence unit "service-comptePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "service-compte/pom.xml":
...
artifacts ("service-compte-ejb.jar" and "service-compte-web.war") are already built. You can build
