...
a persistence unit "service-changePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "service-change/pom.xml":
...
artifacts ("service-change-ejb.jar" and "service-change-web.war") are already built. You can build
