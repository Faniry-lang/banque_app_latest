...
a persistence unit "service-centralPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "service-central/pom.xml":
...
artifacts ("service-central-ejb.jar" and "service-central-web.war") are already built. You can build
